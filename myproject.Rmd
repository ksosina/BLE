...
if(!file.exists(file.path("..", "Text","codebook.csv"))){
  download(url = BNIA_Vital_Signs_Codebook, destfile = file.path("..", "Text","codebook.csv"),
           # method = "curl",
           mode="wb")
}
...
mapply(function(x,y) {
  ...
  if(!file.exists(file.path(".", "raw_data",y))){
    download(url = x, destfile = file.path(".", "raw_data",y),
           # method = "curl",
           mode="wb")
    date_downloaded <- now()
...
{
  download(random_block, destfile = file.path(".", "Plots", "random_block.pdf"),
           # method = "curl",
           mode="wb")
}
# print(getwd())
