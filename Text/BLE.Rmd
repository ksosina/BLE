...
Here, after we find the model that fits the date best, using aggregated data. 
    ...
    2. Then find the delta in predicted life expectancy due to the removed block as $$ T_{\delta_b} = T_{full} – T_{-b} $$ Call this delta the mean life expectancy for that block.
